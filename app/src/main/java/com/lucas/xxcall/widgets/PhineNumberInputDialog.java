...
public class PhineNumberInputDialog extends Dialog {

    private EditText intervalEditText;
    private OnModifySetListener onIntervalSetListener;


    public PhineNumberInputDialog(Context context) {
        super(context);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.phone_number_input_dialog);



        TextView titleTextView = findViewById(R.id.titleTextView);
        titleTextView.setText("号码导入");
